...
<br></br>
 ...
 <div class="row">
 <span style="float: left; margin-left: 350px; color: blue; font-weight: bold; font-size: 25px;">Expense By Date</span>
 </div>
...
{    
  ...
  $query=mysqli_query($conn,"select * from expensedata where email='".$data['email']."' AND  exdate between '{$inputdate1}' AND '{$inputdate2}' ")or die (mysqli_error($conn)); ;
