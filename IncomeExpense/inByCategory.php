...
<span style="float: left; color: green; font-weight: bold; font-size: 25px;"><?php echo $data['fname']; ?>
  ...
  <a class="btn btn-info btn-lg" href="inByDate.php">Search by Date</a>
  </span>
<br></br>
...
<option value="Rent">
 ...
 <div class="row">
 <span style="float: left; margin-left: 350px; color: blue; font-weight: bold; font-size: 25px;">Income By Category</span>
 </div>
...
{    
  ...
  $query=mysqli_query($conn,"select * from incomedata where email='".$data['email']."' AND  incategory='".$inputcat."' ")or die (mysqli_error($conn)); ;
