...
$fetch=mysqli_query($conn,"select * from expensedata where id='$edt'") or die(mysqli_error());
...
<h2 align="center">Update an Expense</h3>
...
<div class="form-group">
  ...
  <div class="col-md-4">
 <input id="dob" type="date" name="exdate" class="form-control datepicker" id="dob" required="" value="<?php echo $exdate;?>">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input name="payee" type="text" placeholder="Payee Name" class="form-control input-md" required="" value="<?php echo $payee;?>">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
      <input list="Category" name="excategory" class="form-control input-md" required="" value="<?php echo $excategory;?>">
...
$query=mysqli_query($conn,"update expensedata set email='$email',exdate='$exdate',amt='$amt',payee='$payee',excategory='$excategory',description='$desc' where id='$edt'") or die(mysqli_error($conn));
     
     if($query>0)
     {
       echo "<script>alert('Your Expense is Updated successfully!! Please Check Income Data.')</script>";
       echo "<script>window.location.href='expenseRecord.php'</script>";
     }
     else
     {
